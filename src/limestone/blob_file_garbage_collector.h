...
protected:
    ...
    /**
     * @brief Retrieves the list of BLOB file paths generated by the scanning process.
     *
     * @return A vector of boost::filesystem::path objects representing the found BLOB files.
     *
