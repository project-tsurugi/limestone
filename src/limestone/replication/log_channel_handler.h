...
/**
 * @brief Handler serving one log channel connection of the TCP replication.
 *
 * Data reception in RDMA mode is handled by rdma_log_channel_receiver; this
 * class is not involved in it.
 */
